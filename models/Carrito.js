...
const CarritoSchema = new mongoose.Schema({
    ...
    productos: [{ // Arreglo de productos seleccionados
        productoId: {type: mongoose.Schema.Types.ObjectId, ref: 'Producto',  required: true  },
        nombre: String,          // ej: "Filtro de Papel"
        presentacion: String,    // ej: "Pack 100 unidades"
        molienda: { type: String, default: 'N/A'      },// Para accesorios no aplica
        cantidad: { 
            type: Number,  required: true, min: [1, 'Mínimo 1 unidad'], default: 1  },
